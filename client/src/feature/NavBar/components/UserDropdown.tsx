...
export const UserDropdown: FC<UserDropdownProp> = ({ userRef, toggleUserDropdown, setLogin }): JSX.Element => {
  ...
  return (
    <div
      ref={userRef}
      className="flex-col items-center gap-y-3 absolute w-60 top-[56px] right-[-16px] border-[1px] transition bg-secondary-black border-zinc-700"
    >
