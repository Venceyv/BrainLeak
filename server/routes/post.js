...
postRouter.post('/:postId/comment/:commentId/reply', checkPostExist, checkCommentExist, verifyToken(), replyValidator, replyToComment);
...
postRouter.delete('/:postId/comment/:commentId', checkPostExist, checkCommentExist, verifyToken(), checkCommentAuth, deleteComment);
postRouter.delete(
